...
python3.11 -m venv bacpipe/.venv
...
Checkpoints auto-download to `bacpipe/checkpoints/` (gitignored)
...
python bacpipe/pipeline_bacpipe.py \
...
- The main purpose of this integration is to compare model representations and acoustic fingerprints across the same processing methods. Species labels or classifier confidence are not used for this experiment.
